...
$date_validite = time() + $un_an;  // on calcul la date de validité du cookie à un an à partir de maintenant
...
// Il n'existe pas de fonction prédéfinie permettant de SUPPRIMER un cookie. On peut cependant le rendre invalide en lui mettant une date d'expiration à 0 ou dépassée, ou encore mettre uniquement le nom de cookie dans setcookie().
